...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    describe("Add Multiple New Products To Cart Tests", () => {
        ...
        //Test 009c -> add multiple new products ("Blue Long Denim Shirt") to cart test (as a registered user) (the webpage is bugged -> additional random product is being added to cart without test script)
        test("Add Multiple New Products To Cart Test (as a registered user)", async function () {
            ...
            //valid add new user address test
            await testMethods.validAddNewUserAddressTest();
            //add multiple new products ("Blue Long Denim Shirt") to cart test (as a registered user)
            await testMethods.addMultipleNewProductsToCartRegUserTest();
        });
